...
const [isYearly, setIsYearly] = useState(false)
  ...
  return (
    ...
    <h1 className="text-3xl text-purple-600 mb-4"> welcome to EBRONICS game </h1>
    <button className="bg-purple-600 text-white px-4 py-2 rounded-md hover:bg-purple-700">Sign Up</button>
    </div>
    </div>
